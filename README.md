___
# ООП практика - Завдання 4 - Єдалов Артем
...
#### **View.java** - Шаблон проєктування Factory Method.<br> Інтерфейс "фабрикованих" об'єктів. Оголошує методи відображення об'єктів.
<details>
<summary>ПЕРЕГЛЯНУТИ</summary>
...
#### **Viewable.java** - Шаблон проєктування Factory Method.<br> Оголошує метод, що "фабрикує" об'єкти.
<details>
<summary>ПЕРЕГЛЯНУТИ</summary>
